...
public class Customer {
	...
	public String toString() {
		return "Customer: " + lastname + ", " + firstname + ", " + phone + ", " + "First Reservation: " + firstReservationDate.getDayOfMonth() + "/" + firstReservationDate.getMonthValue() + "/" + firstReservationDate.getYear();
	}
